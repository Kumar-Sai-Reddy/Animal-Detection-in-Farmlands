...
def send_email(label):
    ...
    Sender_Email = "gurramkumarsaireddy@gmail.com"
    Reciever_Email = "sairocky1980@gmail.com"
    # Password = input('Enter your email account password: ')
    Password = 'qqek dqof sbxe wykh'   #ENTER GOOGLE APP PASSWORD HERE
...
args = {"confidence":0.84, "threshold":0.8}
flag = False
